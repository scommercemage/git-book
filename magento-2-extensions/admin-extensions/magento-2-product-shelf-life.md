...
#### <mark style="color:orange;">Update Batch with Batch code 'xyz' Using API: -</mark> <a href="#bookmark25" id="bookmark25"></a>
...
#### <mark style="color:orange;">Update Batch with ID 1 Using API: -</mark> <a href="#bookmark25" id="bookmark25"></a>
